    ...
    public ArrayList<JZzhichu> GetZhiChuList(String selection){
    	...
    	Cursor cursor=db.query(JZSqliteHelper.ZHICHU, null, selection, null, null, null, "ID DESC");
	    	...
	    	while(!cursor.isAfterLast()&&(cursor.getString(1)!=null)){
	    		...
	    		zhichu.setZc_Year(cursor.getInt(2));
	    		zhichu.setZc_Month(cursor.getInt(3));
	    		zhichu.setZc_Week(cursor.getInt(4));
	    		zhichu.setZc_Day(cursor.getInt(5));
	    		zhichu.setZc_Count(cursor.getDouble(6));
	    		zhichu.setZc_Beizhu(cursor.getString(7));
    ...
    public ArrayList<JZshouru> GetShouRuList(String selection){
    	...
    	Cursor cursor=db.query(JZSqliteHelper.SHOURU, null, selection, null, null, null, "ID DESC");
	    	...
	    	while(!cursor.isAfterLast()&&(cursor.getString(1)!=null)){
	    		...
	    		shouru.setSr_Count(cursor.getDouble(6));
	    		shouru.setSr_Beizhu(cursor.getString(7));
